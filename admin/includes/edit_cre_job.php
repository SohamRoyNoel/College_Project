<?php
    ...
    if(isset($_POST['update_job'])) {
      ...
      print("<script>window.alert('Job Updated');</script>");
 	...
 	<!---->
        ...
        <form id="form"  action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-6 form-group1">
              ...
              <input maxlength="30" value="<?php echo $title1; ?>" type="text" placeholder="Title" required="" name="title">
            </div>
          ...
          <div class="col-md-6 form-group1">
           ...
           <div class="col-md-6 form-group1">
            ...
            <div class="col-md-6 form-group1">
              ...
              <input maxlength="30" minlength="5" value="<?php echo $hremail1; ?>" type="email" placeholder="Email" required=""  name="hremail">
            </div>
            <div class="clearfix"> </div>
            <br>
